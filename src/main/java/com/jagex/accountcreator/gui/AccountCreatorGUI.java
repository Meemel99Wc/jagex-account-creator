...
public class AccountCreatorGUI extends JFrame {
    private static final Logger log = LoggerFactory.getLogger(AccountCreatorGUI.class);
        ...
        new Thread(() -> {
            try {
                ...
                SwingUtilities.invokeLater(() -> {
                    JOptionPane.showMessageDialog(AccountCreatorGUI.this,
                            "Error: " + e.getMessage(),
                            "Error", JOptionPane.ERROR_MESSAGE);
                    resetUI();
                });
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            AccountCreatorGUI gui = new AccountCreatorGUI();
            gui.setVisible(true);
        });
    }
}